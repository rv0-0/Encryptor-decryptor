...
"min-width:10px;")
        ...
        self.encrypt_btn.clicked.connect(self.decrypt_button_clicked) 
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Decryptor-by Ravi"))
        self.label.setText(_translate("MainWindow", "Input File Name"))
        self.label_2.setText(_translate("MainWindow", "Output File Name"))
        self.encrypt_btn.setText(_translate("MainWindow", "Decrypt"))
    ...
    def decrypt_button_clicked(self):
        ...
        obj = decryptor(input_file_name,output_file_name,path)
        msg=obj.func()
